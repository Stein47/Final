...
public class Deck {
	...
	//Deck Array
	//M01/6, Use of Arrays in order to create a deck of cards and deal out those cards
	...
	/*
	 * M01- write code that manipulates an array. Code removes from top of the array
	 */
